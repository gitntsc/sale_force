            ...
            <div class="animated fadeIn">
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        ...
                                        <select name="ddlSelect" id="ddlSelect">
																					...
																					<option value="company_name" <? if($_POST["ddlSelect"]=="company_name"){echo"selected";}?>>Company</option>
																          <option value="section" <?if($_POST["ddlSelect"]=="section"){echo"selected";}?>>Section</option>
																          <option value="username" <?if($_POST["ddlSelect"]=="username"){echo"selected";}?>>Name</option>
																        </select>
                ...
                <?php
                   ...
                   $conn = mysqli_connect($serverName,$userName,$userPassword,$dbName);
                 	...
                 	$sql = "SELECT * FROM report WHERE $ddlSelect LIKE '%".$txtKeyword."%' ";
