                                    ...
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																				<?php
																				 ...
																				 $sql = "SELECT * FROM report WHERE appt1 = '".$_SESSION['username']."' and(approve_stat != 'approve') order by case_id desc limit {$start} , {$perpage} ";
...
<li>
<a href="manager_page.php?page=1" aria-label="Previous">
...
<?php } ?>
<li>
<a href="manager_page.php?page=<?php echo $total_page;?>" aria-label="Next">
