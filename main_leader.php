    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><i class="menu-icon fa fa-th"></i><a href="view_calendar_leader.php">ปฏิทิน</a></li>
                    ...
                    <li><i class="fa fa-puzzle-piece"></i><a href="edit_company.php">แก้ไขทะเบียนบริษัท</a></li>
							...
							<li class="menu-item-has-children dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>การตรวจสอบข้อมูล</a>
									<ul class="sub-menu children dropdown-menu">

										<li><i class="menu-icon fa fa-th"></i><a href="pre_view_section.php">ดูรายการรายสัปดาห์ของผู้ใต้บังคับบัญชา</a></li>
										<li><i class="fa fa-table"></i><a href="sub_leader.php">ดูรายงานทั้งหมดของผู้ใต้บังคับบัญชา</a></li>
                  ...
                  <li><i class="menu-icon fa fa-th"></i><a href="search_qu_u.php">ค้นหาประวัติใบเสนอราคา</a></li>
                    ...
                    if($_SESSION['section']=="tech"){
                        ?>
                    <li class="menu-item-has-children dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>การอนุมัติ</a>
									<ul class="sub-menu children dropdown-menu">

										<li><i class="menu-icon fa fa-th"></i><a href="app2_ex.php">อนุมติการขอตัวอย่าง</a></li>
               ...
               <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="customer_all.php">All Customer</a></li>
