...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
													...
													<li><i class="fa fa-table"></i><a href="order_user.php">ดูแยกตามผู้ใช้</a></li>
													<li><i class="fa fa-table"></i><a href="order_all.php">ดูข้อมูลทั้งหมด</a></li>
													<li><i class="fa fa-table"></i><a href="fullview_del.php">ลบข้อมูล</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
                        <ul class="sub-menu children dropdown-menu">
                          <li><i class="menu-icon fa fa-th"></i><a href="work_report.php">Add Report</a></li>
                        </ul>
                    </li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													...
													{
													?>
                            <p class="text-success"><?php echo $objResult2["username"];?></p>
													<?php
												  }
													?>
                        </a>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">$<span class="count">99999</span></div>
                                            <div class="stat-heading">จำนวน Userทั้งหมด</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">จำนวน user ทั้งหมด</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
  ...
  <thead class="thead-dark">
		...
		<?php
		while ($objResult3= mysqli_fetch_assoc($query))
		{
		?>
		  <tr>
		    <td><div align="center"><?php echo $objResult3["u_id"];?></div></td>
			...
			<td align="center"><a href="fullview_mem.php?u_id=<?php echo $objResult3["u_id"];?>">Edit</a></td>
...
<nav>
 ...
 <li>
 <a href="editdata.php?page=1" aria-label="Previous">
 <span aria-hidden="true">&laquo;</span>
 </a>
</li >
 <?php for($i=1;$i<=$total_page;$i++){ ?>
 <li><a href="editdata.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
 <?php } ?>
 <li>
 <a href="editdata.php?page=<?php echo $total_page;?>" aria-label="Next">
