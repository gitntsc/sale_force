    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
                ...
                <div class="login-form">
                    <form name="form1" method="post" action="save_work_report_in.php">
											<div class="form-group">
													<label>หัวข้อ</label>
												<input name="txttitle" class="form-control" type="text" id="txttitle" size="20"  placeholder="Company Name">
											</div>
