	...
	<div class="content">
		...
		<div class="animated fadeIn">
			...
			<div class="row">
				...
				include 'connect.php';
				$strSQL = "SELECT * FROM report WHERE username LIKE '%" . $_POST["ddlSelect2"] . "%'and strdate Between '" . $_POST["strdate"] . "' and '" . $_POST["lastdate"] . "'
							and approve_stat = 'approve' order by case_id desc";
														...
														<thead class="thead-dark">
															...
															?>
																<tr>
																	...
																	<td>
																		<div align="center"><?php echo $objResult2["crt_time"]; ?></div>
																	</td>
																	<td>
