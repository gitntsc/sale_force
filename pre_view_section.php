	        ...
	        <div class="content">
	            ...
	            <div class="animated fadeIn">
										                                ...
										                                <div class="col-lg-12">
										                                    <div class="card-body">
										                                        ...
										                                        <div class="container">
																															...
																															$sql = "SELECT * FROM member where section = '".$_SESSION['section']."' or section = 'sale'";
																								...
																								<div class="col-lg-12">
																										<div class="card-body">
																												...
																												<div class="container">
																													<?php
																													include 'connects.php';
																													$sql = "SELECT * FROM member where section = '".$_SESSION['section']."' and company = '".$_SESSION['company']."'";
																													$query = mysqli_query($conn, $sql);
																													?>
																												<center><div class="form-group">
																													<form name="frmSearch" method="post" action="<?=$_SERVER['SCRIPT_NAME'];?>">
	                ...
	                <?php
									if($_POST['strdate']==''){
	                include 'connect.php';
	         	$strSQL = "SELECT * FROM tbl_event WHERE leader = '".$_SESSION['username']."' order by id desc";
											...
											<div class="col-lg-12">
													<div class="card">
	                                                      ...
	                                                      <thead class="thead-dark">
															...
															include 'connect.php';
											$strSQL = "SELECT * FROM tbl_event WHERE username LIKE '%".$_POST["ddlSelect2"]."%'and start Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."' order by id desc";
														 $objQuery2 = mysqli_query($objCon,$strSQL);
