	    ...
	    <!-- Right Panel -->
	        ...
	        <div class="content">
				...
				<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Search</button>
	                ...
	                include 'connect.php';
	         	echo	$strSQL = "SELECT * FROM example where username = '".$_SESSION['username']."' order by strdate desc";
	                ...
	                ?>
								...
								<?php
									...
									include 'connect.php';
                                    echo	 $strSQL3 = "SELECT * FROM example where username = '".$_SESSION['username']."' and product like '".%$_POST['product']%."' and name_contact like '".%$_POST['name_contact']%."' order by strdate desc";
									...
									include 'connect.php';
                                    echo $strSQL3 = "SELECT * FROM example where username= '".$_SESSION['username']."' and name_contact like '".%$_POST['name_contact']%."' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
                                    echo $strSQL3 = "SELECT * FROM example where  username = '".$_SESSION['username']."'  and name_contact = '".$_POST['name_contact']."' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
                                 ...
                                 strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
								...
								echo $strSQL3 = "SELECT * FROM example where username = '".$_SESSION['username']."' and name_contact like '".$_POST['name_contact']."' and 
                                 strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' order by strdate desc";
									...
									include 'connect.php';
							echo	 $strSQL3 = "SELECT * FROM example where username = '".$_SESSION['username']."' and  product = '".%$_POST['product']%."' and name_contact = '".%$_POST['name_contact']%."' 
                                and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
