...
<body>
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																				...
																				echo  $sql = "SELECT * FROM qutation WHERE username = '".$_SESSION["username"]."' order by qu_id desc limit {$start} , {$perpage} ";
	...
	<?php
$sql2 = "select * from qutation where username = '".$_SESSION["username"]."'";
...
<li>
<a href="pre_view_u.php?page=1" aria-label="Previous">
<span aria-hidden="true">&laquo;</span>
</a>
</li >
<?php for($i=1;$i<=$total_page;$i++){ ?>
<li><a href="edit_quatation.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
<?php } ?>
<li>
<a href="edit_quatation.php?page=<?php echo $total_page;?>" aria-label="Next">
