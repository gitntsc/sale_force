                                    ...
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																				<?php
																				 ...
																				 $sql = "SELECT * FROM tbl_event order by id desc limit {$start} , {$perpage} ";
																				 ...
																				 <table class="table">
		 																		  ...
		 																		  <tbody>
		 																		    <tr>
		 																		  	...
		 																		  	<td><a href="delete_pre.php?id=<?php echo $objResult["id"];?>" onclick="return confirm('คุณต้องการลบหรือไม่')" >Delete </a></td>
...
<li>
<a href="pre_view_del.php?page=1" aria-label="Previous">
<span aria-hidden="true">&laquo;</span>
</a>
</li >
<?php for($i=1;$i<=$total_page;$i++){ ?>
<li><a href="pre_view_del.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
<?php } ?>
<li>
<a href="pre_view_del.php?page=<?php echo $total_page;?>" aria-label="Next">
