          ...
          <div class="container">
                  ...
                  <div class="login-form">
                    ...
                    <label><?php echo $objResult2['strdate'];?></label>
                          ...
                          <label >4.lead time<?php echo $objResult2['lead_w'];?>"><label>หลังจากได้รับใบสั่งซื้อ(กรณีเป็นสินค้าไม่มีสต๊อก)</label><br>

                          <label>Lead time<?php echo $objResult2['lead_d'];?>"><label>หลังจากได้รับใบสั่งซื้อ(กรณีเป็นสินค้ามีสต๊อก)</label><br>
