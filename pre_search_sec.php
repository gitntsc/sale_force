...
?>
	                ...
	                include 'connect.php';
	         				$strSQL = "SELECT * FROM tbl_event WHERE section LIKE '%".$_POST["ddlSelecta"]."%'order by start desc";
	                ...
	                ?>
								...
								<?php
								 ...
								 $strSQL3 = "SELECT * FROM tbl_event WHERE section LIKE '%".$_POST["ddlSelecta"]."%' and username LIKE '%".$_POST["ddlSelectb"]."%'
									and start Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."' order by start desc";
