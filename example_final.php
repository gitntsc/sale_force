	                ...
	                ?>
								...
								<?php
								 ...
								 $strSQL3 = "SELECT * FROM example where product like '%".$_POST['product']."%'  and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where  username = '".$_POST['name']."' and product like '%".$_POST['product']."%' and name_contact
								like '%".$_POST['name_contact']."%' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where username = '".$_POST['name']."' and product like '%".$_POST['product']."%' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where  username = '".$_POST['name']."' and product like '%".$_POST['product']."%' and name_contact like
								'%".$_POST['name_contact']."%' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
							 $strSQL3 = "SELECT * FROM example  product like '%".$_POST['product']."%' and name_contact like '%".$_POST['name_contact']."%' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
							 ...
							 $strSQL3 = "SELECT * FROM example where product like '%".$_POST['product']."%' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
							 $strSQL3 = "SELECT * FROM example where name_contact like '%".$_POST['name_contact']."%' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
