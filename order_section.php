    ...
    ?>
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        ...
                                        <center><div class="form-group">
                                          <form name="frmSearch" method="post" action="<?php $_SERVER['SCRIPT_NAME'];?>">

                                        <label for="sel1">Select Section</label>
                                        <select name="ddlSelect" id="ddlSelect">
                                          <option>- Select -</option>
                                					<option value="savorysc"<?if($_POST["ddlSelect"]){echo"selected";}?>>Savory NutritionSc</option>
                                					<option value="sweetsc"<?if($_POST["ddlSelect"]){echo"selected";}?>>Sweet Nutritionsc</option>
                                		<option value="feednv"<?if($_POST["ddlSelect"]){echo"selected";}?>>Feed Nuevotec</option>
                                		<option value="industrynr"<?if($_POST["ddlSelect"]){echo"selected";}?>>Industry Nutrin</option>
                ...
                include "connect.php";
             		$sql = "SELECT * FROM report WHERE section LIKE '%".$ddlSelect."%' ";
