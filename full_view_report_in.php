...
<?php
include 'connect.php';
echo $strSQL = "SELECT * FROM report_in WHERE username = '".$_SESSION['username']."'";
$objQuery = mysqli_query($objCon,$strSQL);
 ...
 ?>
  ...
  <thead class="thead-dark">
		  ...
		  <tr>
			...
			<th> <div align="center">Status Approve</div></th>
		...
		?>
		  <tr>
		    ...
		    <td><div align="center"><?php echo $objResult["section"];?></div></td>
				<td><div align="center"><?php echo $objResult["subject"];?></div></td>
				<td><div align="center"><?php echo $objResult["date_st"];?></div></td>



			<td><div align="center"><?php echo $objResult["detail"];?></div></td>
			<td><div align="center"><?php echo $objResult["stat_app"];?></div></td>
		 <td align="center"><a href="edit_work_report_in.php?id=<?php echo $objResult["id"];?>">Fullview</a></td>
