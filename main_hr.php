    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><i class="menu-icon fa fa-th"></i><a href="pre_view_calendar.php">Calendar</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="sub_user.php">ดูข้อมูลก่อนพบลูกค้า</a></li>
                        <li><i class="fa fa-table"></i><a href="pre_search_sec.php">ดูข้อมูลแบบแยกฝ่าย</a></li>
