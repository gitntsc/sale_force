...
mysql_select_db("sale_support", $link);

$result = mysql_query("SELECT * FROM member", $link);
$num_rows = mysql_num_rows($result);
?>
                                            <div class="stat-heading">All money</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php echo $num_rows2;?></span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php echo $num_rows;?></span></div>
