                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="ddlSelect2" id="district" class="form-control">
                            <option value="">เลือกรายชื่อ</option>
																						...
																						<input name="lastdate" type="text" id="datepicker2" placeholder="เลือกวันที่">
...
$strSQL5 = "SELECT * FROM username WHERE id = '".$_POST["ddlSelect2"]."'";
$objQuery5 = mysqli_query($objCon,$strSQL5);
$objResult4 = mysqli_fetch_array($objQuery5,MYSQLI_ASSOC);
$_POST["ddlSelectb"]=$objResult5['name_th'];
?>


	                <?php
									if($_POST['ddlSelect']!=="" && $_POST['ddlSelect2']==""){
	                include 'connect.php';
	         				$strSQL = "SELECT * FROM tbl_event WHERE section LIKE '%".$_POST["ddlSelecta"]."%'";
	                ...
	                ?>
													...
													<div class="card">
	                                                      ...
	                                                      <thead class="thead-dark">
	                                                        ...
	                                                        <tr>
																													...
																													<th width="97"> <div align="center">Detail</div></th>
																													 <th width="71"> <div align="center">Start</div></th>
	                                                    	...
	                                                    	?>
	                                                    		<tr>
																														<td><div align="center"><?php echo $objResult2["id"];?></div></td>
																														<td><div align="center"><?php echo $objResult2["username"];?></div></td>
																														<td><div align="center"><?php echo $objResult2["company_name"];?></div></td>
																														<td><div align="center"><?php echo $objResult2["customer_name"];?></div></td>
																													<td><div align="center"><?php echo $objResult2["cuslevel"];?></div></td>
																													<td><div align="center"><?php echo $objResult2["grade"];?></div></td>
																													<td><div align="center"><?php echo $objResult2["detail"];?></div></td>
																													<td><div align="center"><?php echo $objResult2["start"];?></div></td>
																													<td align="center"><?php echo $objResult2["time"];?></td>
																														<td align="center"><?php echo $objResult2["crt_time2"];?></td>

																														<td align="center"><a href="pre_view.php?id=<?php echo $objResult2["id"];?>">edit</a></td>
								...
								<?php
									...
									include 'connect.php';
							echo		  $strSQL3 = "SELECT * FROM tbl_event WHERE section LIKE '%".$_POST["ddlSelecta"]."%' and username LIKE '%".$_POST["ddlSelectb"]."%'
																											...
																											<div class="login-form">
																												...
																												?>
																													<tr>
																														...
																														<td><div align="center"><?php echo $objResult3["company_name"];?></div></td>
																														<td><div align="center"><?php echo $objResult3["customer_name"];?></div></td>
																													<td><div align="center"><?php echo $objResult3["cuslevel"];?></div></td>
																													<td><div align="center"><?php echo $objResult3["grade"];?></div></td>
																													<td><div align="center"><?php echo $objResult3["detail"];?></div></td>
																													<td><div align="center"><?php echo $objResult3["start"];?></div></td>
																													<td align="center"><?php echo $objResult3["time"];?></td>
																														<td align="center"><?php echo $objResult3["crt_time2"];?></td>

																														<td align="center"><a href="pre_view.php?id=<?php echo $objResult3["id"];?>">edit</a></td>
