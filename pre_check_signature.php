                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																		    	...
																		    	$sql = "SELECT * FROM example WHERE who_appt2 = '".$_SESSION['username']."' and appt1 != 'null' and appt2 != 'null' and Draw != '' order by ex_id desc limit {$start} , {$perpage} ";
...
<thead class="thead-dark">
  ...
  <td><div align="center"><?php echo $objResult2["product_use"];?></div></td>
	...
	<?php
$sql2 = "SELECT * FROM example WHERE who_appt2 = '".$_SESSION['username']."' and appt1 != 'null' and appt2 !='null' and Draw != '' order by ex_id desc";
