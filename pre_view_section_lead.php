...
<body>
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																			 ...
																			 $sql = "SELECT * FROM tbl_event where section = '".$_SESSION['section']."' and (leader or leader2 = '".$_SESSION['username']."')   order by id desc limit {$start} , {$perpage} ";
	...
	<?php
$sql2 = "SELECT * FROM tbl_event where section = '".$_SESSION['section']."' and (leader or leader2 = '".$_SESSION['username']."')";
...
<li>
<a href="sec_page.php?page=1" aria-label="Previous">
<span aria-hidden="true">&laquo;</span>
</a>
</li >
<?php for($i=1;$i<=$total_page;$i++){ ?>
<li><a href="sec_page.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
<?php } ?>
<li>
<a href="sec_page.php?page=<?php echo $total_page;?>" aria-label="Next">
