	    ...
	    <!-- Right Panel -->
	        ...
	        <div class="content">
				...
				<button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Search</button>
	                ...
	                include 'connect.php';
	         		 $strSQL = "SELECT * FROM example where section = '".$_SESSION['section']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
	                ...
	                ?>
									...
									<div class="clearfix"></div>
									<?php
								}elseif($_POST['ddlSelect']=="" &&  $_POST['ddlSelect2']!=""){
								?>
								<script>
								alert('กรุณาเลือก Section ก่อน');
								location.href='pre_search_sec.php';
								</script>
								<?php
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and username = '".$_POST['name']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and username = '".$_POST['name']."' and product = '".$_POST['product']."' and name_contact
								= '".$_POST['name_contact']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and username = '".$_POST['name']."' and product = '".$_POST['product']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
								...
								'".$_POST['name_contact']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and product = '".$_POST['product']."' and name_contact = '".$_POST['name_contact']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								$strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and  username = '".$_POST['username']."' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and product like '%".$_POST['product']."%' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and name_contact = '".$_POST['name_contact']."' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
								 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and product like '%".$_POST['product']."%' and appt1 !='null' and appt2 != 'null' order by strdate desc";
									$objQuery3 = mysqli_query($objCon,$strSQL3);
									...
									include 'connect.php';
							 $strSQL3 = "SELECT * FROM example where section = '".$_SESSION['section']."' and username = '".$_POST['name']."' and product = '".$_POST['product']."'
