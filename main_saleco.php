    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><i class="menu-icon fa fa-th"></i><a href="pre_view_calendar.php">ปฏิทิน</a></li>


                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>ข้อมูล</a>
                    <ul class="sub-menu children dropdown-menu">

                        <li><i class="fa fa-table"></i><a href="pre_search_sec.php">แผนการพบลูกค้า</a></li>
            ...
            <li><i class="fa fa-table"></i><a href="search_ex.php">ค้นหาใบขอตัวอย่าง</a></li>
								...
								<li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Download ข้อมูล</a>
                    <ul class="sub-menu children dropdown-menu">

                    <li><i class="fa fa-table"></i><a href="testdownloadexcel.php">Download รายงานการพบลูกค้า</a></li>
                    <li><i class="fa fa-table"></i><a href="downloadexcel3.php">Download รายงานรายสัปดาห์</a></li
               ...
               <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="register_company.php">Register Company</a></li>
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="customer_all.php">All Company</a></li>
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="manager_page.php">Manager Page</a></li>
