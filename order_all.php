    ...
    <div class="content">
                                            ...
                                            <div class="form-group">
                                                <form name="frmSearch" method="post" action="<?= $_SERVER['SCRIPT_NAME']; ?>">
                                                    ...
                                                    <select name="ddlSelect" id="ddlSelect">
                                                        ...
                                                        <option value="sale">Sale Nutrin</option>
                                                    </select>
													...
													$sql = "SELECT * FROM member where section = 'tech' or section = 'savorysc' or section = 'sweetsc'";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title">All report</h4>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-body">
                                ...
                                $sql = "SELECT * FROM report WHERE section = '" . $_POST["ddlSelect"] . "' and username = '" . $_POST["ddlSelect2"] . "' and strdate Between '" . $_POST["strdate"] . "' and '" . $_POST["lastdate"] . "' order by case_id desc";
                                ...
                                <table class="table">
                                    <thead class="thead-dark">
                                        ...
                                        <tr>
                                            ...
                                            <th width="198">
                                                <div align="center">Customer Level</div>
                                            </th>
                                            <th width="198">
                                            ...
                                            <th width="71">
                                                <div align="center">Customer Project</div>
                                            </th>
                                            <th width="71">
                                                <div align="center">Approve stat</div>
                                            </th>
                                            <th width="71">
                                                <div align="center">Fullview</div>
                                            </th>
                                        </tr>
                                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <div align="center"><?php echo $objResult2["case_id"]; ?></div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div align="center"><?php echo $objResult2["company_name"]; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $objResult2["cus_name"]; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $objResult2["cus_level"]; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $objResult2["strdate"]; ?></div>
                                                </td>
