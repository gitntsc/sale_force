    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
                ...
                <div class="login-form">
                    <form name="form1" method="post" action="save_ex_report2.php?ex_id=<?php echo $objResult2["ex_id"];?>">
											<div class="form-group">
													<label>รายการ</label>
												<label name="product" class="form-control" type="text" id="product" size="20" ><?php echo $objResult2['product'];?></label>
											</div>
                        <div class="form-group">
                            <label>ใช้ในผลิตภัณฑ์</label>
                            <label name="product_use" class="form-control" type="text" id="product_use" size="20"><?php echo $objResult2['product_use'];?></label>
                        </div>
                        <div class="form-group">
                            <label>จำนวน</label>
                            <label name="amount" class="form-control" type="text" id="amount" size="20" ><?php echo $objResult2['amount'];?></label>
                        </div>



												<label>วันที่</label><br>
												<label name="strdate" type="date" id="strdate"><?php echo $objResult2['strdate'];?></label>
                        <br>
                        <br>
                        ...
                        <label type="tel" id="tel" name="tel" ><?php echo $objResult2['Tel'];?></label><br><br>
