...
session_start();
	...
	include 'connect.php';
	$strSQL = "SELECT * FROM report WHERE approver = '".$_SESSION['username']."'";
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
														<li><i class="fa fa-puzzle-piece"></i><a href="register_company.php">Register Company</a></li>
														<li><i class="fa fa-puzzle-piece"></i><a href="edit_company.php">Edit Company</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>ปฏิทิน</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i></i><a href="view_calendar.php">Calendar</a></li>

                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>รายงาน</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="work_report.php">Work Report</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="work_report_u.php">Work report ของตัวเr</a></li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <p class="text-success"><?php echo $username;?></p>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Customer ที่ดูแลอยู่</h4>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-body">
...
<?php
include 'connect.php';
$strSQL = "SELECT * FROM customer WHERE leader = '".$_SESSION['username']."'";
$objQuery = mysqli_query($objCon,$strSQL);
 ...
 ?>
  ...
  <thead class="thead-dark">
		  ...
		  <tr>
		    ...
		    <th> <div align="center">Name Company</div></th>
			<th> <div align="center">Name Customer</div></th>
		    <th> <div align="center">Address</div></th>
			<th> <div align="center">Status</div></th>
			<th> <div align="center">Province</div></th>
			<th> <div align="center" size="100">Business Type</div></th>
		...
		?>
		  <tr>
		    ...
		    <td><div align="center"><?php echo $objResult["name_company"];?></div></td>
		    <td><div align="center"><?php echo $objResult["name_cus"];?></div></td>
			...
			<td><div align="center"><?php echo $objResult["business_type"];?></div></td>
