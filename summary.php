						...
						<div class="animated fadeIn">
								...
								<div class="row">
										<div class="col-lg-12">
												<div class="card">
														<div class="card-body">
																<h4 class="box-title">ข้อมูลค่าใช้จ่าย </h4>
														</div>
														<div class="row">
																<div class="col-lg-12">
																		<div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																				<?php
																				include 'connect.php';
																	$query = "SELECT * FROM report WHERE section ='".$_POST["ddlSelect"]."' and username = '".$_POST["ddlSelect2"]."'  and strdate Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."'and (exp_cost > 0 or rest_cost > 0 or other_cost > 0)";
																				$query_run1 = mysqli_query($objCon,$query);
    																		...
    																		$qty += $num['exp_cost'];
																				 ...
																				 <?php
																				 include 'connect.php';
																			 $query = "SELECT * FROM report WHERE section = '".$_POST["ddlSelect"]."' and username = '".$_POST["ddlSelect2"]."' and (exp_cost > 0 or rest_cost > 0 or other_cost > 0) and strdate Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."'";
 																				$query_run = mysqli_query($objCon,$query);
		...
		<tr>
			<th width="91"> <div align="center">Case ID</div></th>
				<th width="91"> <div align="center">Name</div></th>
					<th width="91"> <div align="center">Section</div></th>
			<th width="91"> <div align="center">ค่าทางด่วนทั้งหมด</div></th>
			<th width="98"> <div align="center">ค่าที่พักทั้งหมด</div></th>
		<th width="198"> <div align="center">ค่าอื่นๆทั้งหมด</div></th>
			<th width="198"> <div align="center">รวมค่าใช้จ่ายทั้งหมด</div></th>
			<th width="198"> <div align="center">ดูข้อมูลอย่างละเอียด</div></th>
...
while ($objResult3= mysqli_fetch_assoc ($objQuery3))
	...
	?>
		...
		<tr>
			...
			<td><div align="center"><?php echo $qty2; ?></div></td>
			<td><div align="center"><?php echo $qty3; ?></div></td>
			<td><div align="center"><?php echo $all;?></div></td>
			<td align="center"><a href="fullview3.php?case_id=<?php echo $objResult3["case_id"];?>">Fullview</a></td>
