    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><i class="menu-icon fa fa-th"></i><a href="pre_view_calendar_mgr.php">ปฏิทิน</a></li>
                <li><i class="menu-icon fa fa-th"></i><a href="view_calendar_mgr_tech.php">ปฏิทินดูข้อมูลผู้ใต้บังคับบัญชา</a></li>
                    ...
                    <ul class="sub-menu children dropdown-menu">
                      ...
                      <li><i class="fa fa-puzzle-piece"></i><a href="register_company.php">ลงทะเบียนบริษัท</a></li>
							...
							<li class="menu-item-has-children dropdown">
									...
									<ul class="sub-menu children dropdown-menu">
										<li><i class="menu-icon fa fa-th"></i><a href="sub_user.php">อนุมัติรายงานผู้ใต้บังคับบัญชา</a></li>
            ...
            <li class="menu-item-has-children dropdown">
                    ...
                    <li><i class="menu-icon fa fa-th"></i><a href="preview_quatation.php">ดูใบเสนอราคาที่อนุมัติแล้ว</a></li>
							...
							<li class="menu-item-has-children dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>การอนุมัติ และตรวจสอบข้อมูล</a>
									<ul class="sub-menu children dropdown-menu">
									<li><i class="menu-icon fa fa-th"></i><a href="pre_edit_quatation_cs.php">อนุมัติใบเสนอราคา</a></li>
...
<a class="navbar-brand" href="https://www.nutritionsc.co.th"><img src="images/logo-ntsc.jpg" alt="Logo"></a>
        ...
        <?php
        if($objResult['section']=="sale" || $objResult['section']=="tech")
        {
         ?>
        <div class="top-right">
