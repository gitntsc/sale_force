...
$strSQL = "SELECT * FROM report WHERE username = '".$_SESSION['username']."' order by case_id desc";
$objQuery5 = mysqli_query($objCon,$strSQL);
 ...
 ?>
  ...
  <thead class="thead-dark">
   ...
   <th width="198"> <div align="center">Creat Time</div></th>
	 ...
	 <th width="71"> <div align="center">Fullview</div></th>
		...
		<tr>
		 ...
		 <td><div align="center"><?php echo $objResult5["section"];?></div></td>
		 <td><div align="center"><?php echo $objResult5["company_name"];?></div></td>
	 <td><div align="center"><?php echo $objResult5["cus_name"];?></div></td>
   <td><div align="center"><?php echo $objResult5["strdate"];?></div></td>
   <td><div align="center"><?php echo $objResult5["crt_time"];?></div></td>




	 <td align="center"><a href="fullview3.php?case_id=<?php echo $objResult5["case_id"];?>">Fullview</a></td>
