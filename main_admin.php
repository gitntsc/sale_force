            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                      ...
                      <li><i class="fa fa-table"></i><a href="fullview_del_ad.php">ลบข้อมูล</a></li>
                      <li><i class="fa fa-table"></i><a href="summary.php">ดูผลรวมทั้งหมด</a></li>
                      <li><i class="menu-icon fa fa-th"></i><a href="register_pre.php">ลงรายการรายสัปดาห์</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-th"></i><a href="view_calendar.php">Calendar</a></li>
