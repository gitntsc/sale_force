...
$strSQL = "SELECT * FROM report WHERE username = '".$_SESSION['username']."'";
$objQuery5 = mysqli_query($objCon,$strSQL);
 ...
 ?>
  ...
  <thead class="thead-dark">
	 ...
	 <td align="center"><a href="order_del.php?case_id=<?php echo $objResult5["case_id"];?>" onclick="return confirm('คุณต้องการลบหรือไม่?')" >Delete </a>
</td>
