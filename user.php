...
<nav>
 ...
 <li>
 <a href="order_all.php?page=1" aria-label="Previous">
 <span aria-hidden="true">&laquo;</span>
 </a>
</li >
 <?php for($i=1;$i<=$total_page;$i++){ ?>
 <li><a href="order_all.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
 <?php } ?>
 <li>
 <a href="order_all.php?page=<?php echo $total_page;?>" aria-label="Next">
