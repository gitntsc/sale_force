                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
														<li><i class="fa fa-puzzle-piece"></i><a href="register_company.php">เพิ่มข้อมูลลูกค้า</a></li>
														<li><i class="fa fa-puzzle-piece"></i><a href="edit_company.php">แก้ไขข้อมูลลูกค้า</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i></i><a href="work_report.php">เขียนรีพอต์ท</a></li>
                            <li><i class="fa fa-table"></i><a href="work_report_u.php">รีพอต์ทที่บันทึกไว้</a></li>
                        </ul>
                    </li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">ลูกค้าที่ดูแลอยู่</h4>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-body">
