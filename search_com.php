...
<?php
	...
	if(isset($_POST["ddlSelect2"]))
  {
	...
	if(isset($_POST["ddlSelect3"]))
	{
		$ddlSelect = $_POST["ddlSelect3"];
	}
            ...
            <div class="animated fadeIn">
							              ...
							              <div class="form-row">
							                 ...
							                 <div class="form-group col-md-12">
							                        <label for="district">เลือกรายชื่อ</label>
															...
															<div class="form-group col-md-12">
																	<label>รายชื่อลูกค้า</label><br>
																<input name="ddlSelect3" type="text" id="ddlSelect3">
															</div>
																						...
																						<div class="col-lg-12">
																								<div class="card-body">
																										...
																										<div class="container">
																											<?php
																											include('connects.php');
																											$sql = "SELECT * FROM member where section = '".$_SESSION['section']."'";
																											$query = mysqli_query($conn, $sql);
																											?>
																										<center><div class="form-group">
																											<form name="frmSearch" method="post" action="<?=$_SERVER['SCRIPT_NAME'];?>">
							...
							<?php
							 ...
							 ?>
							 	<?php
							 	                include 'connect.php';
							 	         		$strSQL = "SELECT * FROM report WHERE username LIKE '%".$_POST["ddlSelect"]."%'and company_name LIKE '%".$_POST["ddlSelect3"]."%' and strdate Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."' order by case_id desc";
							 													...
							 													<div class="card">
							 	                                                      ...
							 	                                                      <thead class="thead-dark">
							 																													...
							 																													<td><div align="center"><?php echo $objResult2["strdate"];?></div></td>
							 																													  ...
							 																													  <td align="center"><?php echo $objResult2["crt_time"];?></td>

							 																													  <td align="center"><a href="fullview3.php?case_id=<?php echo $objResult2["case_id"];?>">edit</a></td>
