                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
																			<?php
																			 ...
																			 $sql = "SELECT * FROM report limit {$start} , {$perpage} ";
...
<thead class="thead-dark">
	...
	?>
		...
		<td align="center"><?php echo $objResult2["contact"];?></td>
			...
			?>
		<td align="center"><a href="order_del.php?case_id=<?php echo $objResult2["case_id"];?>">Delete</a></td>
...
<li>
<a href="fullview_del_ad.php?page=1" aria-label="Previous">
<span aria-hidden="true">&laquo;</span>
</a>
</li >
<?php for($i=1;$i<=$total_page;$i++){ ?>
<li><a href="fullview_del_ad.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
<?php } ?>
<li>
<a href="fullview_del_ad.php?page=<?php echo $total_page;?>" aria-label="Next">
