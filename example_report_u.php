...
<?php
$strSQL = "SELECT * FROM example WHERE username = '".$_SESSION['username']."'  order by ex_id desc";
  ...
  <thead class="thead-dark">
   ...
   <td><div align="center"><?php echo $objResult5["address_send"];?></div></td>
    <td><div align="center"><?php echo $objResult5["name_contact"];?></div></td>
	 ...
	 <td align="center"><a href="pre_example.php?ex_id=<?php echo $objResult5["ex_id"];?>">Edit</a></td>
