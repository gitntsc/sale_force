...
<?php
 ...
 ?>
						...
						if($_POST['district']==''){
							include 'connect.php';
					 $strSQL = "SELECT * FROM report WHERE company = '".$_SESSION['company']."' and section = '".$_SESSION['section']."' order by case_id desc";
						 														 ...
						 														 <div class="container">
						 																		 ...
						 																		 <div class="login-form">
						 																			 ...
						 																			 <thead class="thead-dark">
						 																				 ...
						 																				 <th width="198"> <div align="center">Create Time</div></th>
...
?>
	                ...
	                include 'connect.php';
	        echo 		$strSQL = "SELECT * FROM report WHERE username LIKE '%".$_POST["ddlSelect2"]."%'and strdate Between '".$_POST["strdate"]."' and '".$_POST["lastdate"]."' order by case_id desc";
	                $objQuery2 = mysqli_query($objCon,$strSQL);
