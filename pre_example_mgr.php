    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
                ...
                <div class="login-form">
                    <form name="form1" method="post" action="save_ex_report.php?ex_id=<?php echo $objResult2["ex_id"];?>">
                        ...
                        <div class="form-group">
                            ...
                            <input name="ref_no" class="form-control" type="text" id="ref_no" size="20"  value="<?php echo $objResult2['ref_no'];?>">
												...
												<div class ="form-group">
                         <label>วันที่</label>
                         <input name="strdate" class="form-control" type="date" id="strdate"  value = "<?php echo $objResult2['strdate'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <option value="<?=$objResult2['tech_name']?>"><?=$objResult2['tech_name']?></option>
         ...
         <div class="container">
                 ...
                 <div class="login-form">
                     <form name="form1" method="post" action="save_ex_report.php">
                         ...
                         <label><?php echo $objResult2['tech_name'];?></label>
