                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-card-o"></i><a href="editdata.php">Edit User</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="user.php">ALL User</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body">
                                      ...
                                      <?php
																			...
																			$strSQL = "SELECT * FROM report WHERE approve_stat != 'approve'";
...
<thead class="thead-dark">
	...
	?>
		...
		<td align="center"><a href="fullview.php?case_id=<?php echo $objResult2["case_id"];?>">Fullview</a></td>
																		                ...
																		                <div class="login-form">
																											<form name="form1" method="post" action="save_fullview.php?case_id=<?php echo $_GET["case_id"];?>">
																											 <div class="form-group">
																												 ...
																												 <input name="txtCusname" class="form-control" type="text" id="txtCusname" size="20"  placeholder="<?php echo $objResult3["company_name"];?>">
																											 </div>
																													<div class="form-group">
																															<label>ชื่อลูกค้า</label>
																															<input name="txtCusname" class="form-control" type="text" id="txtCusname" size="20"  placeholder="<?php echo $objResult3["cus_name"];?>">
																													</div>
																													<div class="form-group">
																															<label>ตำแหน่ง</label>
																															<input name="txtCuslevel" type="text" class="form-control" placeholder="<?php echo $objResult["cus_level"];?>" id="txtCuslevel">
																													</div>
																												 <div class="form-group">
																														 <label>ผู้มีอำนาจการตัดสินใจ</label>
																														 <input name="txtApprover" type="text" class="form-control" placeholder="<?php echo $objResult["approver"];?>" id="txtApprover">
																												 </div>
																												 <div class="form-group">
																														 <label>บุคลิกลักษณะลูกค้า</label>
																														 <input name="txtPersonal" type="text" class="form-control" placeholder="<?php echo $objResult["personality"];?>" id="txtPersonal">
																												 </div>
																									 ...
																									 <input name="txtContact" type="text" class="form-control" placeholder="<?php echo $objResult["contact"];?>" id="txtContact">
																										 </div>
																										 ...
																										 <div class="input-group">
																												...
																												<textarea class="form-control" aria-label="With textarea" name="txtDetail" id="txtDetail" placeholder="<?php echo $objResult["Detail"];?>"></textarea>
																											</div><br>

																										 <div class="form-group">
																								 <label for="sel1">Project ลูกค้า</label>
																								 <input name="txtCuspro" type="text" class="form-control" placeholder="<?php echo $objResult["cus_project"];?>" id="txtCuspro">
																										</div>
																										<div class="form-group">
																												<label>คาดการณ์การสั่งซื้อสินค้า (สินค้า และ ปริมาณ)</label>
																												<input name="txtVol" type="text" class="form-control" placeholder="<?php echo $objResult["volume"];?>" id="txtVol">
																										</div>

																										<label>ข้อมูลคู่แข่ง</label>
																										<div class="form-group">
																												<label>สินค้า</label>
																												<input name="txtPro" type="text" class="form-control" placeholder="<?php echo $objResult["com_pro"];?>" id="txtPro">
																										</div>
																										<div class="form-group">
																												<label>source</label>
																												<input name="txtSou" type="text" class="form-control" placeholder="<?php echo $objResult["com_source"];?>" id="txtSou">
																										</div>
																										<div class="form-group">
																												<label>ราคา</label>
																												<input name="txtCost" type="text" class="form-control" placeholder="<?php echo $objResult["com_cost"];?>" id="txtCost">
																										</div>
																										<div class="form-group">
