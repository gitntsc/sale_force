                                    ...
                                    <div class="card-body">
                                        <!-- <canvas id="TrafficChart"></canvas>   -->
																				<?php
																				 ...
																				 $sql = "SELECT * FROM report WHERE appt2 = '".$_SESSION['username']."' and(approve_stat != 'approve') order by case_id desc limit {$start} , {$perpage} ";
...
<thead class="thead-dark">
	...
	<?php
$sql2 = "SELECT * FROM report WHERE appt1 = '".$_SESSION['username']."' and(approve_stat != 'approve') order by case_id desc";
...
<li>
<a href="sub_user.php?page=1" aria-label="Previous">
<span aria-hidden="true">&laquo;</span>
</a>
</li >
<?php for($i=1;$i<=$total_page;$i++){ ?>
<li><a href="sub_user.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>|
<?php } ?>
<li>
<a href="sub_user.php?page=<?php echo $total_page;?>" aria-label="Next">
